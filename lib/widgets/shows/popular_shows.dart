...
import 'package:flutterappmovie/bloc/shows/get_popular_shows_bloc.dart';
...
class PopularShows extends StatefulWidget {
  @override
  _PopularShowsState createState() => _PopularShowsState();
}
...
class _PopularShowsState extends State<PopularShows> {
  ...
  void initState() {
    super.initState();
    popularShowsBloc..getShows();
  }

  @override
  Widget build(BuildContext context) {
    print('PopularShows() build');
    return Column(
      ...
      children: <Widget>[
        ...
        StreamBuilder<ShowResponse>(
          stream: popularShowsBloc.subject.stream,
