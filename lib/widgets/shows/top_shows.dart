...
import 'package:flutterappmovie/bloc/shows/get_top_shows_bloc.dart';
...
class TopShows extends StatefulWidget {
  @override
  _TopShowsState createState() => _TopShowsState();
}

class _TopShowsState extends State<TopShows> {
  @override
  void initState() {
    print('check init TopShows()');
    super.initState();
    topShowsBloc..getShows();
  }

  @override
  Widget build(BuildContext context) {
    print('TopShows() build');
    return Column(
      ...
      children: <Widget>[
        ...
        StreamBuilder<ShowResponse>(
          stream: topShowsBloc.subject.stream,
